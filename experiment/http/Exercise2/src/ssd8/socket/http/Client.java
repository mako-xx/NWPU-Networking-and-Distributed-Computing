...
public class Client {
     ...
     * GET：文件保存根目录
     */
    static private String pathname = "/Users/yangxixuan/Desktop/Exercise2/output/";
    ...
    public static void main(String[] args) {
        try {
            ...
            if (request.startsWith("GET")) {
                ...
                screen.flush();
                String filename = pathname + keyboard.readLine();
                ...
                if (true) {
                    ...
                    outfile.flush();
                    screen.println("SUCCESS: file saved to " + filename);
                    outfile.close();
                } else {
                    screen.println("ERROR: fail to save");
                }
            }
